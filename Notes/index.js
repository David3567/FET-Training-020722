...
// // //     console.log(this.getPi(), num1, num2, this.gettest())
// // // }
...
// // // const newget1 = getArea.bind(obj).bind(test);
// // // // newgetArea(20, 21);
// // // newget1(20, 21);
...
// // (async() => {
// //     console.log('Second', await promisifyFunction(add)(1, 1));
// //     console.log('Second', await promisifyFunction(multiplyByTwo)(3).then(val => val + 1));
// // })();
...
// // console.log('res: ', numbers.myReduce(myFunc, 0));
...
//     function(acc, cur) {
//         const newitem = acc.length !== 0 ? acc[acc.length - 1] + cur : cur;
//         return [...acc, newitem]; // [2, 4, 7, 11]
//     }, []
// );
...
(async() => {
    console.log(await promisifyFunction(add)(1, 1));
    console.log(await promisifyFunction(multiplyByTwo)(3).then(val => val + 1));
})();

promisifyFunction(add)(1, 1).then(console.log);
promisifyFunction(multiplyByTwo)(3).then(val => val + 1).then(console.log)
